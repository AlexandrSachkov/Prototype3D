...
namespace p3d
{
	namespace util
	{
		...
		bool ImguiRenderer::initialize(void* dev, void* devContext)
		{
			auto device = static_cast<ID3D11Device*>(dev);
			auto devCon = static_cast<ID3D11DeviceContext*>(devContext);
		...
		bool ImguiRenderer::createDeviceObjects(ID3D11Device* device, ID3D11DeviceContext* devCon)
		{
		...
		bool ImguiRenderer::createFontAndTextures(ID3D11Device* device, ID3D11DeviceContext* devCon)
		{
			// Build texture atlas
		...
		void ImguiRenderer::render(void* dev, void* devContext, ImDrawData* drawData)
		{
			auto device = static_cast<ID3D11Device*>(dev);
			auto devCon = static_cast<ID3D11DeviceContext*>(devContext);
